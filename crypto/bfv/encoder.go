// Package bfv implements a RNS-accelerated Fan-Vercauteren version of Brakerski's scale
//invariant homomorphic encryption scheme. It provides modular arithmetic over the integers.
package bfv
...
// It provides methods to embed []uint64 and []int64 types into the various plaintext types and
// the inverse operations. It also provides methods to convert between the different plaintext types.
// The different plaintext types represent different embeddings of the message in the polynomial space.
...
//
//
// The different plaintext types have different efficiency-related caracteristics that we summarize
// in the Table below. For more information about the different plaintext types, see plaintext.go.
//
