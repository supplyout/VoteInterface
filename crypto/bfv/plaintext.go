...
// result of (缩放)scaling the corresponding element of R_t up by Q/t. This is a generic all-purpose type
// of plaintext: it will work with for all operations. It is however less compact than PlaintextRingT
// and will result in less efficient Cipher-Plaintext multiplication than PlaintextMul. See bfv/encoder.go
